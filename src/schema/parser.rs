...
impl<'a> SchemaParser<'a> {
    ...
    fn expect(&mut self, kind: SchemaSyntax) {
        self.skip_trivia();
        if self.at(kind) {
            self.bump();
        } else {
